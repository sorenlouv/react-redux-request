(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('crypto'), require('react'), require('react-redux')) :
	typeof define === 'function' && define.amd ? define(['exports', 'crypto', 'react', 'react-redux'], factory) :
	(factory((global.ReactReduxRequest = {}),null,global.React,global.ReactRedux));
}(this, (function (exports,crypto,React,reactRedux) { 'use strict';
	...
	*/
	...
	var maybeFetchData = function () {
	  var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref) {
	    var args = _ref.args,
	        ...
	        hashedArgs = _ref.hashedArgs,
	        id = _ref.id,
	        preventFetch = _ref.preventFetch,
	        prevHashedArgs = _ref.prevHashedArgs;
	    ...
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            shouldFetchData = !preventFetch && prevHashedArgs !== hashedArgs && !hasError;
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
	  ...
	  var hashedArgs = objectHash_1(args);
	  ...
	  return {
	    prevHashedArgs: lodash_get(state.reactReduxRequest[id], 'hashedArgs'),
	    hashedArgs: hashedArgs,
